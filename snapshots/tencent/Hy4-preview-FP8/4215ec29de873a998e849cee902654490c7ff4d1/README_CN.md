<p align="left">
   <a href="https://huggingface.co/tencent/Hy4-preview-FP8">English</a>&nbsp;｜&nbsp;中文
</p>
<br>
...
Hy4 preview 提供了完整的模型微调流程，详细的微调文档请参考：[模型微调指南](https://huggingface.co/tencent/Hy4-preview-FP8/blob/main/finetune/README_CN.md)
...
Hy4 preview 基于 **Apache 2.0 许可证** 发布。详情请参阅 [LICENSE](https://huggingface.co/tencent/Hy4-preview-FP8/blob/main/LICENSE)。
