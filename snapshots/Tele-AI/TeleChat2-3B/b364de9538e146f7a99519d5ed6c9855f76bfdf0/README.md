...
>>> tokenizer = AutoTokenizer.from_pretrained('TeleChat2/Telechat2-3B', trust_remote_code=True)
>>> model = AutoModelForCausalLM.from_pretrained('TeleChat2/Telechat2-3B', trust_remote_code=True, device_map="auto",
