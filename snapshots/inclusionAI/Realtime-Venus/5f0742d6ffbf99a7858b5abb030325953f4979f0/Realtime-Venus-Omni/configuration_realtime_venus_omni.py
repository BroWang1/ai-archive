...
class RealtimeVenusOmniSliceConfig(PretrainedConfig):
    model_type = "realtime_venus_omni_vision"
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        ...
        if config_dict.get("model_type") == "realtime_venus_omni_vision":
...
class RealtimeVenusOmniTTSConfig(PretrainedConfig):
    model_type = "realtime_venus_omni_tts"
...
class RealtimeVenusOmniConfig(Qwen3Config):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if slice_config is None:
            self.slice_config = RealtimeVenusOmniSliceConfig(max_slice_nums=1)
        else:
            self.slice_config = RealtimeVenusOmniSliceConfig(**slice_config)
        ...
        if tts_config is None:
            self.tts_config = RealtimeVenusOmniTTSConfig()
        elif isinstance(tts_config, dict):
            self.tts_config = RealtimeVenusOmniTTSConfig(**tts_config)
        elif isinstance(tts_config, RealtimeVenusOmniTTSConfig):
